...
args = commandArgs(trailingOnly=T);  args[1]<- c("UT-A01290-230627"); # args[1] <-c("UT-VH00770-230714"); #
...
for (i in 1:n){
  ...
  # info for SARS-CoV-2-Tracking system
  ...
  # json files: fastas2json (This part needs to be run fo=om the LWS to access the /Home/....) 
  # ========================
